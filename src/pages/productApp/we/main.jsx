...
export default function WeTv() {
    ...
    return (
      ...
      <Card className="w-40 h-60 md:w-60 md:h-72 border-2">
        ...
        <div className="flex justify-center">
          <img className="w-14 h-14 md:w-28 md:h-28" src={wetv} alt="youtube-play--v1" />  
        </div>
  ...
  return (
    ...
    >
      <h3 className="text-start font-bold mb-7 ">WeTv Premium</h3>
      <div className="flex max-w-6xl gap-8 justify-center item-center align-middle flex-wrap ">
        {youtubeTipe('WeTv Premium','8k','1 Month', 'https://wa.me/6287868785129?text=Beli%20WeTv%20Premium%201%20Bulan%208k')}
        {youtubeTipe('WeTv Premium','15k','8 Month', 'https://wa.me/6287868785129?text=Beli%20WeTv%20Premium%208%20Bulan%2015k')}
