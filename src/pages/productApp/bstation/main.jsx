  ...
  return (
    ...
    className="flex justify-center items-center flex-col">
      ...
      <div className="flex max-w-6xl gap-8 justify-center item-center align-middle flex-wrap ">
        {youtubeTipe('Bstation Premium','13k','1 Month', 'https://wa.me/6287868785129?text=Beli%20Bstation%20Premium(Sharing)%201%20Bulan%2013k')}
        {youtubeTipe('Bstation Premium','18k','3 Month', 'https://wa.me/6287868785129?text=Beli%20Bstation%20Premium(Sharing)%203%20Bulan%2018k')}
      </div>
      <h3 className="text-start font-bold my-7 ">Indplan Private</h3>
      <div className="flex max-w-6xl gap-8 justify-center item-center align-middle flex-wrap ">
        {youtubeTipe('Bstation Premium','48k','1 Month', 'https://wa.me/6287868785129?text=Beli%20Bstation%20Premium(Sharing)%201%20Bulan%2048k')}
      </div>
